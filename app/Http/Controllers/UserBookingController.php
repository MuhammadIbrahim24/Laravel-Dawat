...
class UserBookingController extends Controller
{
    ...
    public function store(RequestBooking $request)
    {
        ...
        if($booked == null) {
            if($now<$target){
                $booked->create(['fname'=>$request->first_name,'lname'=>$request->last_name,'contact'=>$request->contact,'nic'=>$request->nic,'date'=>$request->date,'email'=>$request->email,'is_confirmed'=>$confirmed]);
