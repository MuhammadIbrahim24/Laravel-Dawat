...
<body>
        ...
        <div>
            ...
            <div style="display:block">
                ...
                <br><br>
                <a href="{{Route('booking.request',$hall->id)}}" class="btn btn-warning col-lg-4 col-lg-offset-4">Request Booking</a>
                <br><br><br>
                <a href="{{Route('consumer.details',$hall->id)}}" class="btn btn-sm btn-primary col-lg-4 col-lg-offset-4">Back To Details</a>
                <br><br>
        </div>
</body>
</html>