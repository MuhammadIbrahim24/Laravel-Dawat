            ...
            <div id="form2" style='display:none;' class="col-lg-12">
                {!! Form::open(['method'=>'POST', 'action'=>'ConsumerController@searchByArea']) !!}
                        ...
                        <div class="col-lg-12">
                            ...
                            <br>
                            {!! Form::select('city',[0 => '-Select-']+$cities ,null, ['class'=>'col-lg-10']) !!}
                            <br>
                        </div>
                        <br><br>
                        <div class="col-lg-12">
                            ...
                            <br>
                            {!! Form::select('area',[0=>'-Select-'] ,null,  ['class'=>'col-lg-10']) !!}
                        </div>
                        <br>
...
<div class="container">
    <div class="row set-row-pad"  >
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
            ...
            <h4><strong>Email: </strong>info@dawat.com</h4>
        </div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1" data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
        <div >
            <a href="https://web.facebook.com/">  <img src="{{asset('/img/Social/facebook.png')}}" alt="" /> </a>
            <a href="https://web.gmail.com/"> <img src="{{asset('/img/Social/google-plus.png')}}" alt="" /></a>
            <a href="https://web.twitter.com/"> <img src="{{asset('/img/Social/twitter.png')}}" alt="" /></a>
        </div>
    </div>
</div>
</div>
